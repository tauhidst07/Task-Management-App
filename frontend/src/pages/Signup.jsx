  ...
  return (
    <div className='flex justify-center'> 
      <form onSubmit={handleSubmit(submitHandler)}>
             <div className='my-2'>
                <p>Name: </p>  
                <input type="text" {...register("name",{required:"name is required"})} className='outline outline-1' /> 
             ...
             <button type='submit' className='text-center bg-gray-900 text-white py-2 px-4 rounded-md my-3'>Signup</button>
